      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div className="bg-neutral-50/80 p-8 md:p-10 rounded-2xl">
            <h3 className="text-xl font-serif font-medium text-neutral-900 mb-8">
              Send Us a Message
            </h3>
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="text-[13px] text-neutral-600 mb-2 block font-medium">
                    Full Name
                  </label>
                  <Input
          ...
          <div>
            ...
            <p className="text-neutral-500 leading-relaxed mb-10 text-[15px]">
              Share your family&apos;s requirements and we&apos;ll guide you to
              the right villa or flat inside Haldwani. We can also schedule
              same-day walk-throughs from our AK Tower office.
            </p>
