...
const contactInfo = [
  {
    icon: MapPin,
    title: "Visit Us",
    details: ["LuxeLiving Tower, Level 15", "Bandra Kurla Complex", "Mumbai 400051, India"],
  },
  {
    icon: Phone,
    title: "Call Us",
    details: ["+91 22 6789 0000", "+91 98765 43210", "Toll Free: 1800 123 4567"],
  },
  {
    icon: Mail,
    title: "Email Us",
    details: ["info@luxeliving.com", "sales@luxeliving.com", "support@luxeliving.com"],
  },
  {
    icon: Clock,
    title: "Working Hours",
    details: ["Monday - Friday: 9AM - 7PM", "Saturday: 10AM - 5PM", "Sunday: By Appointment"],
  },
]
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        {contactInfo.map((info) => (
          ...
          <div className="w-12 h-12 rounded-xl bg-neutral-800 flex items-center justify-center mb-6">
            <info.icon className="w-5 h-5 text-neutral-400" strokeWidth={1.5} />
          </div>
          <h3 className="text-lg font-medium text-white mb-4">{info.title}</h3>
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
            <label htmlFor="name" className="block text-[13px] font-medium text-neutral-700 mb-2">
              Full Name *
            </label>
            <input
              type="text"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
            <label htmlFor="phone" className="block text-[13px] font-medium text-neutral-700 mb-2">
              Phone Number *
            </label>
            <input
              type="tel"
            ...
            <div>
            <label htmlFor="interest" className="block text-[13px] font-medium text-neutral-700 mb-2">
              Property Interest
            </label>
            <select
              id="interest"
          ...
          <div>
            <label htmlFor="subject" className="block text-[13px] font-medium text-neutral-700 mb-2">
            Subject *
            </label>
            <input
            type="text"
          ...
          <div>
            <label htmlFor="message" className="block text-[13px] font-medium text-neutral-700 mb-2">
            Message *
            </label>
            <textarea
            id="message"
        ...
        <div>
          ...
          {/* Offices List */}
          <div>
          <h3 className="text-xl font-serif font-medium text-neutral-900 mb-6">Our Offices</h3>
          <div className="space-y-4">
            ...
            >
              <div>
              <h4 className="font-medium text-neutral-900 mb-1">{office.city}</h4>
              <p className="text-[13px] text-neutral-500">{office.address}</p>
              </div>
              <div className="text-right">
              <p className="text-[13px] text-neutral-600">{office.phone}</p>
      ...
      <div className="container mx-auto px-6 lg:px-12 text-center">
        ...
        Our property consultants are ready to show you our exclusive listings and help you find the perfect home.
        </p>
